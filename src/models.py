...
class FavCharacters(db.Model):
    ...
    user: Mapped[list['User']] = relationship(back_populates='favorites_characters_list')
    people: Mapped[list['Characters']] = relationship(back_populates='favorites')
...
class FavPlanets(db.Model):
    ...
    user_id: Mapped[int] = mapped_column(ForeignKey('user.id'))
    planets: Mapped[list['Planets']] = relationship(back_populates='favorites')
    user: Mapped[list['User']] = relationship(back_populates='favorites_planets_list')
...
class FavStarships(db.Model):
    ...
    user_id: Mapped[int] = mapped_column(ForeignKey('user.id'))
    user: Mapped[list['User']] = relationship(back_populates='favorites_starships_list')
    starships_list: Mapped[list['Starships']] = relationship(back_populates='favorites')
